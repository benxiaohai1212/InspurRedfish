...
@OdataTypes({
    "#VolumeMetrics" + OdataTypeVersions.VERSION_PATTERN + "VolumeMetrics"
})
@SuppressWarnings({"checkstyle:MethodCount"})
public class VolumeMetricsResource extends ExternalServiceResourceImpl {
    @JsonProperty("CapacityUsedBytes")
