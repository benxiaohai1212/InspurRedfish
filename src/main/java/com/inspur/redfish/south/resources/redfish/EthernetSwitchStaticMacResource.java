...
@OdataTypes({
    "#EthernetSwitchStaticMAC" + OdataTypeVersions.VERSION_PATTERN + "EthernetSwitchStaticMAC"
})
public class EthernetSwitchStaticMacResource extends ExternalServiceResourceImpl implements ExternalServiceResource {
